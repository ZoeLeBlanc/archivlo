        ...
        return editableDirectiveFactory({
          ...
          render: function() {
            ...
            if (this.attrs.eInputgroupleft || this.attrs.eInputgroupright) {
              this.inputEl.wrap('<div class="input-field col s12"></div>');
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" class="waves-effect waves-light btn">save</button>',
      cancelTpl:    '<button type="button" ng-click="$form.$cancel()" class="waves-effect waves-light btn">cancel</button>',
      resetTpl:    '<button class="waves-effect waves-light btn" type="reset">clear</button>'
    },
